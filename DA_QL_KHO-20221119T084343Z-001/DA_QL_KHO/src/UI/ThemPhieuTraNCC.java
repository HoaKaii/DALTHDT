 ...
 * @author P50
 */
public class ThemPhieuTraNCC extends javax.swing.JFrame {

    /**
     * Creates new form TaoPhieuTraNCC
     */
    public ThemPhieuTraNCC() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mã Lô Sản Phẩm");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemPhieuTraNCC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemPhieuTraNCC().setVisible(true);
            }
        });
    }
