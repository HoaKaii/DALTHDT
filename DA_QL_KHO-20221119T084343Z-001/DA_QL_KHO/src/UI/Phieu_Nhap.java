...
public class Phieu_Nhap extends javax.swing.JFrame {
    ...
    public void DoDuLieuVaoTable(){
        String sql =    "SELECT PHIEUNHAP.ID_Phieu_Nhap, PHIEUNHAP.Thoi_Gian,CHITIETPHIEUNHAP.So_Tien_Lo, NHANVIEN.Ten_Nv\n" +
                        "FROM PHIEUNHAP,CHITIETPHIEUNHAP,NHANVIEN\n" +
                        "WHERE PHIEUNHAP.ID_Phieu_Nhap=CHITIETPHIEUNHAP.ID_Phieu_Nhap\n" +
                        "and PHIEUNHAP.ID_Nv=NHANVIEN.ID_Nv\n" +
                        "ORDER by PHIEUNHAP.Thoi_Gian DESC";
        ResultSet rs = ConnectionDB.excuteQuery(sql);
        
        DefaultTableModel tbModel = (DefaultTableModel)tbnhap.getModel();
        Object obj[] = new Object[10];
        try{
            while(rs.next()){
                obj[0]=rs.getString("ID_Phieu_Nhap");
                obj[1]=rs.getTimestamp("Thoi_Gian");
                obj[2]=rs.getString("So_Tien_Lo");
                obj[3]=rs.getString("Ten_NV");
